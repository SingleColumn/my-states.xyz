      ...
      <section className="help-about-dialog" role="dialog" aria-modal="true" aria-labelledby="help-about-title" tabIndex={-1}>
        ...
        <div className="help-about-content">
          ...
          <section aria-labelledby="help-about-panels">
            ...
            <p>There is no formatting toolbar: the page stays quiet. Type <code>#</code> at the start of a line for a heading, <code>-</code> for a list, <code>&gt;</code> for a quote, or wrap words in <code>**</code> for bold and <code>*</code> for italic, and the marks turn into formatting as you type. <strong>Text size</strong> in the header steps the editor text through four sizes; the choice is remembered.</p>
